...
M.setup = function(opts)
  ...
  -- keymaps
  vim.keymap.set({'n', 'x', 'o'}, "<Plug>ImSelect_toggle_auto_insert", M.toggle_insert_im_auto, { silent = true, desc = "Toggle auto select insert im"})
  vim.keymap.set({'n', 'x', 'o'}, "<Plug>ImSelect_toggle_auto_normal", M.toggle_normal_im_auto, { silent = true, desc = "Toggle auto select normal im"})

	if opts ~= nil and opts.keymaps ~= nil then
    if opts.keymaps.togle_auto_select_normal then
      vim.keymap.set({'n'}, opts.keymaps.togle_auto_select_normal, "<Plug>ImSelect_toggle_auto_normal", { silent = true, desc = "Toggle auto select normal im"})
    end
    if opts.keymaps.togle_auto_select_insert then
      vim.keymap.set({'n'}, opts.keymaps.togle_auto_select_insert, "<Plug>ImSelect_toggle_auto_insert", { silent = true, desc = "Toggle auto select insert im"})
    end
  end
end
